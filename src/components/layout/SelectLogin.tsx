    ...
    <div className="bg-[var(--bg)] flex items-center justify-center min-h-screen">
      <div className="text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link href={'/auth/login'} className="bg-teal-300 text-[var(--bg)] text-lg font-semibold py-2 px-4 rounded-full w-48">
            Teacher&apos;s
          </Link>
          <Link href={'/auth/login'} className="bg-[var(--first)] text-[var(--bg)] text-lg font-semibold py-2 px-4 rounded-full w-48">
            Student&apos;s
          </Link>
        </div>
      </div>
